...
json{
  ...
  "values": [],
  "success": false,
  "message": " [specific reason why query cannot be generated highly important] else write nothing in this field. if user is asking some questions to you you can add your response here . also use this for user greetings.User ko uski same language me response krna hai ]"
}
DATABASE SCHEMA:
